...
// DB_PATH pins the location (Docker, production). Otherwise ./data under
// wherever the process was started, which for `npm run dev` is api/.
export const DEFAULT_DB_PATH = process.env.DB_PATH ?? path.join(process.cwd(), "data", "nutrition.db");
